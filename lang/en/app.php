...
return [
    ...
    'auth' => [
        ...
        'mfa_challenge_title' => 'Two-factor verification',
        'mfa_challenge_section' => 'Two-factor authentication',
        'mfa_challenge_description' => 'Open Google Authenticator or Authy and enter the 6-digit code.',
        'mfa_session_expired' => 'Session expired. Please login again.',
        'mfa_config_error' => 'MFA setup error.',
    ],
    'nav' => [
    ...
    'dashboard' => [
        'admin' => [
            ...
            'mrr_evolution_6_months' => 'MRR evolution — last 6 months',
            'latest_proposals' => 'Latest 5 Proposals',
            'number' => 'Number',
            'no_active_partners' => 'No partners with active projects',
            'no_proposals' => 'No proposals',
            'recent_vms' => 'Recent VMs (latest 5)',
            'vm' => 'VM',
            'os' => 'OS',
            'monthly_value' => 'Monthly value',
            'no_vms' => 'No VMs registered',
        ],
        'distributor' => [
    ...
    'company' => [
        'form' => [
            ...
            'identity_description' => 'Main IPVDATA information',
            'logo_helper' => 'PNG, JPG, SVG or WEBP. Max 4MB.',
            'company_data_description' => 'General company information and identification',
            ...
            'logo_description' => 'Upload logo (PNG, JPG or SVG)',
            'logo' => 'Logo',
            'contact' => 'Contact',
            'contact_description' => 'Company contact information',
            'website' => 'Website',
            'address_section' => 'Address',
            'address_description' => 'Company location',
            'zipcode' => 'ZIP code',
            'city' => 'City',
            'state' => 'State',
            'full_address' => 'Full address',
            'saved' => 'Company data saved successfully!',
