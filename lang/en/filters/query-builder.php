    ...
    'operators' => [
        ...
        'date' => [
            ...
            'is_date' => [
                ...
                'label' => [
                    'direct' => 'Is on date',
                    'inverse' => 'Is not on date',
                ],

                'summary' => [
                    'direct' => ':attribute is on :date',
                    'inverse' => ':attribute is not on :date',
                ],
            ...
            'is_month' => [
                ...
                'label' => [
                    'direct' => 'Is in month',
                    'inverse' => 'Is not in month',
                ],

                'summary' => [
                    'direct' => ':attribute is in :month',
                    'inverse' => ':attribute is not in :month',
                ],
            ...
            'is_year' => [
                ...
                'label' => [
                    'direct' => 'Is in year',
                    'inverse' => 'Is not in year',
                ],

                'summary' => [
                    'direct' => ':attribute is in :year',
                    'inverse' => ':attribute is not in :year',
                ],
        ...
        'relationship' => [
            ...
            'has_min' => [
                ...
                'label' => [
                    'direct' => 'Has minimum',
                    'inverse' => 'Has fewer than',
                ],

                'summary' => [
                    'direct' => 'Has minimum :count :relationship',
                    'inverse' => 'Has fewer than :count :relationship',
                ],
