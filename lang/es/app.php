...
return [
    ...
    'auth' => [
        ...
        'mfa_challenge_title' => 'Verificación en dos factores',
        'mfa_challenge_section' => 'Autenticación en dos factores',
        'mfa_challenge_description' => 'Abre Google Authenticator o Authy e ingresa el código de 6 dígitos.',
        'mfa_session_expired' => 'Sesión expirada. Inicia sesión nuevamente.',
        'mfa_config_error' => 'Error en la configuración de MFA.',
    ],
    'nav' => [
    ...
    'dashboard' => [
        'admin' => [
            ...
            'mrr_evolution_6_months' => 'Evolución MRR — últimos 6 meses',
            'latest_proposals' => 'Últimas 5 Propuestas',
            'number' => 'Número',
            'no_active_partners' => 'Ningún socio con proyectos activos',
            'no_proposals' => 'Ninguna propuesta',
            'recent_vms' => 'VMs Recientes (últimas 5)',
            'vm' => 'VM',
            'os' => 'SO',
            'monthly_value' => 'Valor/mes',
            'no_vms' => 'No hay VMs registradas',
        ],
        'distributor' => [
    ...
    'company' => [
        'form' => [
            ...
            'identity_section' => 'Identidad de la Empresa',
            'identity_description' => 'Información principal de IPVDATA',
            'logo_helper' => 'PNG, JPG, SVG o WEBP. Máx 4MB.',
            'company_data_description' => 'Información general e identificación de la empresa',
            'legal_name' => 'Razón Social',
            'trade_name' => 'Nombre Fantasía',
            'tax_id' => 'NIF/CIF',
            'state_registration' => 'Inscripción Estatal',
            'active' => 'Activa',
            'logo_section' => 'Logo de la Empresa',
            'logo_description' => 'Subir logotipo (PNG, JPG o SVG)',
            'logo' => 'Logo',
            'contact' => 'Contacto',
            'contact_description' => 'Información de contacto de la empresa',
            'website' => 'Sitio web',
            'address_section' => 'Dirección',
            'address_description' => 'Ubicación de la empresa',
            'zipcode' => 'Código Postal',
            'city' => 'Ciudad',
            'state' => 'Estado',
            'full_address' => 'Dirección completa',
            'saved' => '¡Datos de la empresa guardados con éxito!',
            'save' => 'Guardar datos de la empresa',
        ],
    ],
    'settings' => [
