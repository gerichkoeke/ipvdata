...
return [
    ...
    'auth' => [
        ...
        'mfa_challenge_title' => 'Verificação em dois fatores',
        'mfa_challenge_section' => 'Autenticação em dois fatores',
        'mfa_challenge_description' => 'Abra o Google Authenticator ou Authy e digite o código de 6 dígitos.',
        'mfa_session_expired' => 'Sessão expirada. Faça login novamente.',
        'mfa_config_error' => 'Erro na configuração do MFA.',
    ],
    'nav' => [
    ...
    'dashboard' => [
        'admin' => [
            ...
            'mrr_evolution_6_months' => 'Evolução MRR — últimos 6 meses',
            'latest_proposals' => 'Últimas 5 Propostas',
            'number' => 'Número',
            'no_active_partners' => 'Nenhum parceiro com projetos ativos',
            'no_proposals' => 'Nenhuma proposta',
            'recent_vms' => 'VMs Recentes (últimas 5)',
            'vm' => 'VM',
            'os' => 'OS',
            'monthly_value' => 'Valor/mês',
            'no_vms' => 'Nenhuma VM registrada',
        ],
        'distributor' => [
            'network_mrr' => 'MRR da Rede',
            'network_mrr_hint' => 'Soma dos projetos ativos dos parceiros',
            'estimated_commission' => 'Comissão Estimada',
            'of_mrr' => 'do MRR',
            'partners' => 'Parceiros',
            'total' => 'total',
            'active' => 'ativos',
            'network_customers' => 'Clientes na Rede',
            'active_vms' => 'VMs Ativas',
            'top_partners_mrr' => 'Top 5 Parceiros por MRR',
            'customers_evolution_6_months' => 'Evolução de Clientes — últimos 6 meses',
            'network_partners' => 'Parceiros da Rede',
            'partner' => 'Parceiro',
            'customers' => 'Clientes',
            'commission' => 'Comissão',
    ...
    'customer_infra' => [
        ...
        'virtual_datacenter' => 'Centro de Dados Virtual',
        'read_only' => 'Visualização somente leitura',
        'rate' => 'Taxa',
        'active_vms' => 'VMs Ativas',
        'total_ram' => 'RAM Total',
        'monthly_revenue' => 'Receita/Mês',
        'customer_network' => 'Rede do Cliente',
        'shared_across_vms' => 'Compartilhada entre todas as VMs',
        'network_type' => 'Tipo de Rede',
        'bandwidth' => 'Banda',
        'topology' => 'Topologia',
        'public_ips' => 'IP(s) Público(s)',
        'monthly_cost' => 'Custo/Mês',
        'virtual_machines' => 'Máquinas Virtuais',
        'generate_proposal' => 'Gerar Proposta',
    ...
    'company' => [
        'form' => [
            ...
            'identity_section' => 'Identidade da Empresa',
            'identity_description' => 'Informações principais da IPVDATA',
            'logo_helper' => 'PNG, JPG, SVG ou WEBP. Máx 4MB.',
            'company_data_description' => 'Informações gerais e identificação da empresa',
            'legal_name' => 'Razão Social',
            'trade_name' => 'Nome Fantasia',
            'tax_id' => 'CNPJ',
            'state_registration' => 'Inscrição Estadual',
            'active' => 'Ativa',
            'logo_section' => 'Logo da Empresa',
            'logo_description' => 'Upload da logomarca (PNG, JPG ou SVG)',
            'logo' => 'Logo',
            'contact' => 'Contato',
            'contact_description' => 'Informações de contato da empresa',
            'website' => 'Website',
            'address_section' => 'Endereço',
            'address_description' => 'Localização da empresa',
            'zipcode' => 'CEP',
            'city' => 'Cidade',
            'state' => 'Estado (UF)',
            'full_address' => 'Endereço completo',
            'saved' => 'Dados da empresa salvos com sucesso!',
            'save' => 'Salvar dados da empresa',
        ],
    ],
    'settings' => [
