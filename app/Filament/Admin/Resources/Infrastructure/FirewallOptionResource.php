...
use App\Models\FirewallOption;
use Filament\Forms;
use Filament\Forms\Form;
use Filament\Resources\Resource;
use Filament\Tables;
use Filament\Tables\Table;
use App\Filament\Admin\Resources\Infrastructure\FirewallOptionResource\Pages;

class FirewallOptionResource extends Resource
{
    protected static ?string $model            = FirewallOption::class;
    protected static ?string $navigationIcon   = 'heroicon-o-shield-check';
    protected static ?string $navigationLabel  = 'Opções de Firewall';
    protected static ?string $navigationGroup  = 'Infraestrutura';
    protected static ?string $modelLabel       = 'Firewall';
    protected static ?string $pluralModelLabel = 'Firewalls';
    ...
    {
        return ['index' => Pages\ListFirewallOptions::route('/')];
    }
}
