        ...
        <div class="px-6 py-4 space-y-5">
            <div class="grid grid-cols-2 gap-3">
                <div class="col-span-2">
                    ...
                    <input type="text" wire:model="proposta_titulo"
                        class="w-full rounded-lg bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-sm text-gray-900 dark:text-white px-3 py-2 focus:ring-1 focus:ring-emerald-500 outline-none"/>
                </div>
                <div>
            ...
            <div class="rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/40 p-3">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        <x-heroicon-m-signal class="w-4 h-4 text-primary-500 dark:text-primary-400"/>
                        <span class="text-sm font-semibold text-gray-900 dark:text-white">Rede</span>
                        <span class="text-[10px] text-gray-500 dark:text-gray-400">{{ $data['rede']->networkType?->name }}</span>
                    </div>
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" wire:model="proposta_incluir_rede" class="rounded border-gray-400 dark:border-gray-600 text-emerald-500"/>
                        <span class="text-[11px] text-gray-600 dark:text-gray-400">Incluir na proposta</span>
                    </label>
                </div>
            </div>
            @endif
                ...
                <div class="space-y-2">
                    ...
                    <label class="flex items-center justify-between rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/40 px-3 py-2.5 cursor-pointer hover:border-emerald-300 dark:hover:border-gray-600 hover:bg-emerald-50 dark:hover:bg-gray-800/60 transition-colors">
                        <div class="flex items-center gap-2.5">
                            ...
                            <div>
                                <p class="text-sm font-semibold text-gray-900 dark:text-white">{{ $vm->name }}</p>
                                <p class="text-[10px] text-gray-500 dark:text-gray-400">{{ $vm->osDistribution?->name }} · {{ $vm->cpu_cores }} vCPUs · {{ $vm->ram_gb }}GB RAM</p>
                            </div>
                        </div>
                ...
                <div class="space-y-2">
                    ...
                    <label class="flex items-center justify-between rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/40 px-3 py-2.5 cursor-pointer hover:border-emerald-300 dark:hover:border-gray-600 transition-colors">
                        <div class="flex items-center gap-2.5">
                            ...
                            <div>
                                <p class="text-sm font-semibold text-gray-900 dark:text-white">S3 · {{ $s3->size_gb }} GB</p>
                                <p class="text-[10px] text-gray-500 dark:text-gray-400">R$ {{ number_format($s3->price_per_gb,4,',','.') }}/GB</p>
                            </div>
                        </div>
                ...
                <div class="space-y-2">
                    ...
                    <label class="flex items-center justify-between rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/40 px-3 py-2.5 cursor-pointer hover:border-emerald-300 dark:hover:border-gray-600 transition-colors">
                        <div class="flex items-center gap-2.5">
                            ...
                            <div>
                                <p class="text-sm font-semibold text-gray-900 dark:text-white">Backup Gerenciado</p>
                                <p class="text-[10px] text-gray-500 dark:text-gray-400">{{ $bkp->machine_count ?? 1 }} máquina(s) · {{ $bkp->total_disk_gb ?? 0 }}GB</p>
                            </div>
                        </div>
            ...
            <div>
                ...
                <textarea wire:model="proposta_notas" rows="3"
                    class="w-full rounded-lg bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-sm text-gray-900 dark:text-white px-3 py-2 focus:ring-1 focus:ring-emerald-500 outline-none resize-none placeholder-gray-400 dark:placeholder-gray-500"
